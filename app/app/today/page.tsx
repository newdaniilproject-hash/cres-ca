...
export default async function AppHome() {
  ...
  // конечная остановка всех редиректов кабинета. `redirect('/app')` со
  // всех остальных страниц приходит на вход раздела (`app/app/page.tsx`),
  // а тот уводит сюда каждого, у кого нет склада. Проверка права здесь
  // означала бы цикл редиректов.
  //
