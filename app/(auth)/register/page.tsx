    ...
    const { data, error } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          ...
          // Кем зарегистрировался — от этого зависит, куда его приземлит
          // `nextRoute` в следующий вход, пока заведения нет (0118).
          // Без этой строки покупатель попадал на «створіть заклад».
          intent: 'buyer',
        },
      },
    })
