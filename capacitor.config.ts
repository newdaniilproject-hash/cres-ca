...
const config = {
  ...
  server: {
    ...
    androidScheme: 'https',
    // Куда веб-вью разрешено уходить, не открывая внешний браузер.
    ...
    allowNavigation: [
      ...
      // Доменов провайдеров входа здесь БОЛЬШЕ НЕТ: вход через Google
      // удалён целиком решением владельца 18.08.2026 (правило 8).
      // Если провайдера когда-нибудь вернут, домен придётся вернуть
      // и сюда — без него веб-вью откажется уходить на его страницу.
    ],
  },
